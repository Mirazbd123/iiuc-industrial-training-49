...
simple_string = "Hello, Python learners and learners!"
...
bio_data = "Name : Miraz , Age : 25 , Country : Bangladesh"
bio_data_split = bio_data.split(' , ')
print(bio_data_split[0])
print(bio_data_split[1])
print(bio_data_split[2])
...
# Write your code below:
person = {'name': 'Mirazul', 'age': 25, 'city': 'Chittagong'}
...
text = "my name is khan and i am a muslim"
...
# Positive Lookahead
pattern = r'\d{1}(?=px)'  # Matches a number only if it's followed by 'px'
